...
public class P1_cssSelector_Cybertek {
    ...
    public static void main(String[] args) {
       ...
       // driver.manage().window().maximize();
        ...
        WebElement retrievePassswordButton = driver.findElement(By.cssSelector("button[id= 'form_submit']"));
        ...
        System.out.println("forgotPasswordHeader.isDisplayed() = " + inputEmail.isDisplayed());

        System.out.println("retrievePassswordButton.isDisplayed() = " + retrievePassswordButton.isDisplayed());
